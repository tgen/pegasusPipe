...
#PBS -S /bin/bash
#SBATCH --job-name="pegasus_cuffDiff"
...
perf stat ${CUFFDIFFPATH}/cuffdiff -p 16 -N -M ${MASK} -b ${REF} -L Control,Tumor ${GTF} ${BAM1} ${BAM2} 2> ${DIRNAME}.cuffDiff.perfOut > ${DIRNAME}.cuffDiffOut
if [ $? -eq 0 ] ; then
